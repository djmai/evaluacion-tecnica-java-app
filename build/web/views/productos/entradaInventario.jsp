<%-- 
    Document   : entradaInventario.jsp
    Created on : 12 oct 2024, 23:05:42
...
<div class="container mt-5">
    <div class="card shadow-lg">
        <div class="card-header text-center">
            <h5 class="highlighted-title">Entrada de Inventario</h5>
        </div>
        <div class="card-body">
            ...
            <form action="${pageContext.request.contextPath}/actualizarInventario" method="post">
                ...
                <div class="mb-3">
                    <label for="cantidad_nueva" class="form-label">Agregar Cantidad:</label>
                    <input type="number" class="form-control" id="cantidad_nueva" name="cantidad_nueva" required>
                </div>

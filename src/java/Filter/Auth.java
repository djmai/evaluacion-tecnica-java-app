...
public class Auth implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        // Si está intentando acceder a la raíz y está autenticado, redirigir al home
        if (requestURI.equals(req.getContextPath() + "/") && loggedIn) {
            res.sendRedirect(req.getContextPath() + "/inicio");
            return;
        }

        // Si está logueado o es una solicitud al login, permite el acceso
